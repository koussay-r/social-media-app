...
<div role="status " className='z-[100]'>
    <svg aria-hidden="true" class="w-8 block mx-auto h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
